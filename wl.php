...
<div style="background-color: #F2F2F2;">
    ...
    <div class="row adminNavigations">
        ...
        <div class="adminNavs col-md-2" style="background-color:#DEEBF7; border-color:gold; border-width:3px;">
                <?php
                    include_once('utilities/dbconnect.php');
...
<div class="container-fluid adminContBorder" style="background-color:#DEEBF7;">
    <div class="container">
        <div class="row">
            <div class="col-lg-8"><br>
                <h2 class="rounded adminHead">Wish List</h2>
                    ...
                    <table class="table table-hover" style="background-color:#F2F2F2; font-size:15px;">
                        ...
                        <tbody>
                                <?php
                                    ...
                                    $sqlWishers = mysqli_query($conn,"select * from wishers");
                                    // fetch data from database
                                    while($row = mysqli_fetch_array($sqlWishers))
                                    {
                                        $id = $row['id'];
                                        $name = $row['name'];
                                        $type = $row['type'];
                            ...
                            <tr>
                                ...
                                <td><?= $energy; ?></td>
                                <td class="text-right">
                                <a href="viewWish.php?id=<?= $id; ?>" class="actions mr-2"><i class="fas fa-expand text-primary" style=" font-size:15px;"></i></a>
                                <a href="processes/delWish.php?id=<?= $id; ?>" onclick="return confirm('Are you Sure to Delete this Wisher from the list?')" class="actions mr-2"><i class="fas fa-trash text-danger" style=" font-size:15px;"></i></a>
                                </td>	
                            </tr>
                        </tbody>
                            <?php
            ...
            <div class="col-lg-4"><br>
                <h2 class="rounded adminHead">Matches</h2>
                <div class="table-responsive">
                    <table class="table table-hover" style="background-color:#F2F2F2; font-size:15px;">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                                <?php
                                    ...
                                    $sqlAnimals = mysqli_query($conn,"SELECT * from animals");
                                    while($row = mysqli_fetch_array($sqlAnimals))
                                    {
                                        $pID = $row['id'];
                                        $type = $row['type'];
                                        $pName = $row['name'];
                                        ...
                                        $sqlMatch = mysqli_query($conn,"SELECT * from wishers WHERE type = '$type' AND energy = '$energy' AND gender = '$gender'");
                                        while($row = mysqli_fetch_array($sqlMatch))
                                        {
                                            $wID = $row['id'];
                                            $name = $row['name'];
                                            $matched = $pName;
                            ...
                            <tr>
                                ...
                                <td><?= $matched; ?></td>
                                <td class="text-right">
                                <a href="viewWish.php?id=<?= $wID; ?>" class="actions mr-2"><i class="fas fa-expand text-primary" style=" font-size:15px;"></i></a>
                                <a href="processes/emailMatched.php?pID=<?= $pID; ?>&id=<?= $wID; ?>" class="actions mr-2"><i class="fas fa-envelope text-success" style=" font-size:15px;"></i></a>
                                </td>	
                            </tr>
                        </tbody>
                            <?php
