...
<div class="container" style="box-shadow: 0 1px .5rem rgba(0,0,0,.5);
    ...
    <?php
        ...
        $id = $_GET['id'];
        $sqlAdopt = mysqli_query($conn, "SELECT * FROM foster WHERE id = $id");
            while($row = mysqli_fetch_array($sqlAdopt)){
    ?>
    <div style="background-color: #001C54; height:40px; padding:8px;" class="text-right ">
        <a href="fc.php" class="btn btn-secondary">Back</a>
        <a href="processes/appFF.php?id=<?= $id; ?>" class="btn btn-success">Approve</a>
        <a href="processes/rejFF.php?id=<?= $id; ?>" onclick="return confirm('Are you Sure to Reject this Application? This will also be deleted from the application list.')" class="btn btn-danger">Reject</a>
    </div>
    <?php } ?>
        ...
        <div class="container">
            ...
            <?php
                ...
                while($row = mysqli_fetch_array($sql)){
                    $name = $row['name'];
            ?>
            <h2 style="color:rgb(150, 150, 150);">Applying for <?php echo $name; ?>'s Foster Care.</h2>
            <?php } ?>
            <br><br>
            <div style="font-size:12px;">
                ...
                include_once('utilities/dbconnect.php');
                $id = $_GET['id'];
                $sqlFoster = mysqli_query($conn, "SELECT * FROM foster WHERE id = $id");
                ...
                <div class="row mb-4">
                    <div class="col">
                        <div class="form-check">
                            ...
                            <input class="input" type="text" placeholder="<?php echo $row['petWith']; ?>">
                        </div>
                    </div>
                </div>
                <div>
                ...
                <h2>Foster Care Questions:</h2><br>
                <div class="row mb-4">
                    <div class="col">
                        <div class="form-check">
                            <h4 style="display: inline; padding-right:25px;">Have you fostered before?</h4>
                            <input class="input" type="text" placeholder="<?php echo $row['fostered']; ?>">
                        </div>
                    </div>
                </div>
                <div class="form-outline mb-4">
                ...
                <div class="row mb-4">
                    <div class="col">
                        <div class="form-outline">
                            ...
                            <input class="form-input" name="willing" placeholder="<?php echo $row['willing']; ?>" required>
                        </div>
                    </div>
                </div>
                <div class="row mb-4">
                    <div class="col">
                        <div class="form-outline">
                            ...
                            <textarea class="form-input ml-3" placeholder="<?php echo $row['whatWill']; ?>" name="whatWill"></textarea>
                        </div>
                    </div>
                </div>
                <div class="form-outline mb-4">
                ...
                <div class="form-outline mb-4">
                    ...
                    <input class="input" type="text" placeholder="<?php echo $row['others']; ?>">
                </div><br>
            </div><br><br><br><br>
        </div>
        <?php } ?>
