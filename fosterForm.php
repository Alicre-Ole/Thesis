...
?>
    ...
    <div class="container-fluid bg-blue" style="padding:90px 0 0 0; opacity:.8; background-color:#f9f9f9;">
        <div class="container">
            <div>
                <h1 style="font-size: 50px;">Foster Care Application Form</h1><hr>
            </div>
            <?php
                include_once('utilities/dbconnect.php');
                $pID = $_GET['id'];
                ...
                while($row = mysqli_fetch_array($sql)){
                    $name = $row['name'];
            ?>
            <h2 style="color:rgb(150, 150, 150);">Note: You are applying for <?php echo $name; ?>'s Foster Care.</h2>
            <?php } ?>
            <br><br>
            <div style="font-size:12px;">
            <form action="processes/foster.php?pID=<?php echo $pID ?>" method="POST">
                ...
                <div class="form-outline mb-4">
                    <input type="text" id="add" name="add" class="form-control input" />
                ...
                <div class="row mb-4">
                    ...
                    <div class="col">
                        <div class="form-outline">
                            <input type="number" name="cell"  class="form-control input" />
                ...
                <div class="row mb-4">
                    <div class="col">
                        <div class="form-check">
                            <h4 style="display: inline; padding-right:25px;">Have you fostered before?</h4>
                            <input onclick="javascript:adopted();" id="yesAdbtd" class="form-check-input" name="fostered" type="radio" value="yes" required>
                            <label style="padding-right: 30px;" class="form-check-label">Yes</label>
                            <input onclick="javascript:adopted();" id="noAdbtd" class="form-check-input" name="fostered" type="radio" value="no">
                            <label class="form-check-label">No</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-outline mb-4">
                    <h4 style="display: inline; padding-right:25px;">Please state the reason why you want to foster a pet:</h4>
                ...
                <div class="row mb-4">
                    <div class="col">
                        <div class="form-check">
                            <h4 style="display: inline; padding-right:25px;">Are you willing to shoulder the veterinary need of the animal?</h4>
                            <input class="form-check-input" name="willing" onclick="javascript:isWilling();" id="will" type="radio" value="yes" required>
                            <label style="padding-right: 30px;" class="form-check-label">Yes</label>
                            <input class="form-check-input" name="willing" onclick="javascript:isWilling();" id="noWill" type="radio" value="no">
                            <label class="form-check-label">No</label>
                        </div>
                    </div>
                </div>
                <script>
                    function isWilling() {
                        if (document.getElementById('will').checked) {
                            document.getElementById('whatWill').style.display = 'block';
                        }
                        else document.getElementById('whatWill').style.display = 'none';
                    }
                        </script>
                <div class="row mb-4" id="whatWill" style="display: none;">
                    <div class="col">
                        <div class="form-check">
                            <h4 style="display: inline; padding-right:25px;">Since yes, what are you willing to provide?</h4><br>
                            <input class="form-check-input ml-3" name="whatWill" type="checkbox" value="Basic(checkups, vaccinations, de-worming)">
                            <label style="padding-right: 30px;" class=" ml-5 form-check-label">Basic(checkups, vaccinations, de-worming)</label><br>
                            <input class="form-check-input ml-3" name="whatWill" type="checkbox" value="Extensive(Basic + extensive medical procedures)">
                            <div style="display: hidden; position:fixed; opacity:0;">
                                <input class="form-check-input" name="whatWill" type="checkbox" value=" " checked>
                            </div>
                            <label style="padding-right: 30px;" class=" ml-5 form-check-label">Extensive(Basic + extensive medical procedures) </label><br>
                        </div>
                    </div>
                </div>
                <div class="form-outline mb-4">
                ...
                <div class="form-outline mb-4">
                    <h4 style="display: inline; padding-right:25px;">How many hours a day would your fostered dog/cat be alone?</h4>
                ...
                <div class="form-outline mb-4">
                    ...
                    <textarea class="form-control input" name="takeCare" placeholder="Pedro Penduko - 09xxxxxxxxx" rows="1" required></textarea>
                </div>
                <div class="form-outline mb-4">
