...
<div class="container" style="box-shadow: 0 1px .5rem rgba(0,0,0,.5);
    ...
    <div style="background-color: #001C54; height:40px; padding:8px;" class="text-right ">
        ...
        <a href="processes/appAA.php?id=<?= $id; ?>" class="btn btn-success">Approve</a>
        <a href="processes/rejAA.php?id=<?= $id; ?>" onclick="return confirm('Are you Sure to Reject this Application? This will also be deleted from the application list.')" class="btn btn-danger">Reject</a>
    </div>
    <?php } ?>
