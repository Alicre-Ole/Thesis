...
<div class="container" style="box-shadow: 0 1px .5rem rgba(0,0,0,.5);
    ...
    <div style="background-color: #001C54; height:40px; padding:8px;" class="text-right ">
        ...
        <a href="processes/emailFF_signing.php?id=<?= $id; ?>&pID=<?= $pID; ?>" class="btn btn-success">Email</a>
        <a href="processes/rejFF.php?id=<?= $id; ?>" onclick="return confirm('Are you Sure to Cancel this Application? This will also be deleted from the application list.')" class="btn btn-danger">Delete</a>
    </div>
    <?php } ?>
