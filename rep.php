...
<div style="background-color: #F2F2F2;">
    ...
    <div class="row adminNavigations">
        ...
        <div class="adminNavs col-md-2" style="background-color:#1F4E79; border-color:gold; border-width:3px;">
                <?php
                    include_once('utilities/dbconnect.php');
...
<div class="container-fluid adminContBorder" style="background-color:#1F4E79;">
    <div class="container">
        <div class="row">
            <div class="col-lg-6"><br>
                <h2 class="rounded adminHead">Lost & Found</h2>
                ...
                <table class="table table-hover" style="background-color:#F2F2F2; font-size:15px;">
                        ...
                        <tbody>
                                <?php
                                    ...
                                    $sqlLF = mysqli_query($conn,"SELECT * from lfreport");
                                    while($row = mysqli_fetch_array($sqlLF))
                                    {
                                        $id = $row['id'];
                                        $name = $row['name'];
                                        $number = $row['number'];
                            ...
                            <tr>
                                <td class="text-right">
                                <a href="processes/updateLF.php?id=<?= $id; ?>" class="actions mr-2"><i class="fas fa-check text-success" style=" font-size:15px;"></i></a>
                                <a href="processes/delLF.php?id=<?= $id; ?>" onclick="return confirm('Are you Sure to Delete this Report from the list?')" class="actions mr-2"><i class="fas fa-trash text-danger" style=" font-size:15px;"></i></a>
                                </td>
                                <td><?= $id; ?></td>
                                <td><?= $name; ?></td>
                                <td><?= $number; ?></td>
            ...
            <div class="col-lg-6"><br>
                <h2 class="rounded adminHead">Animal Cruelty</h2>
                <div class="table-responsive">
                    <table class="table table-hover" style="background-color:#F2F2F2; font-size:15px;">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                                <?php
                                    ...
                                    $sqlLF = mysqli_query($conn,"SELECT * from acreport");
                                    while($row = mysqli_fetch_array($sqlLF))
                                    {
                                        $id = $row['id'];
                                        $name = $row['name'];
                            ...
                            <tr>
                                <td class="text-right">
                                <a href="processes/updateAC.php?id=<?= $id; ?>" class="actions mr-2"><i class="fas fa-check text-success" style=" font-size:15px;"></i></a>
                                <a href="processes/delAC.php?id=<?= $id; ?>" onclick="return confirm('Are you Sure to Delete this Report from the list?')" class="actions mr-2"><i class="fas fa-trash text-danger" style=" font-size:15px;"></i></a>
                                </td>
                                <td><?= $id; ?></td>
                                <td><?= $name; ?></td>
                                <td><?= $number; ?></td>
