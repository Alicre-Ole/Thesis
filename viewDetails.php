...
<div class="container upPet" style="box-shadow: 0 1px .5rem rgba(0,0,0,.5);
    ...
    <div class="p-3">
        <a href="index.php"><i class="fas fa-arrow-left mr-5" style="font-size: large; color:black;"></i></a>
    ...
    ?>
                        <div class="row bg-light">
                            <div class="col-lg-4 text-center" style="margin-top: auto; margin-bottom:auto;">
                                ...
                                ?>
                                <label style="font-size: 30px;" class="bg-danger pl-5 pr-5 text-white"><?= $status; ?></label>
                                <?php 
                                    }
                                ?>
                            </div>
