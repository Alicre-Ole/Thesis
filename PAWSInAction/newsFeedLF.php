    ...
    <div class="myContainer container">
            <div class="col-lg-12 col-md-12 col-sm-12 col-lg-4 col-sm-5 text-right fixed-top" style="background-color:navy;">
                <div class="text-right" style="display: inline;"><br>
                    ...
                    <a href="newsFeedLF.php" class=" p-3 bg-primary text-right ml-1" style="color: white; text-decoration:none; border-radius: 5px;">Lost&Found</a>
            ...
            <?php
                $sqlLF = "SELECT * FROM lfreport WHERE posted = 1 ORDER BY id DESC";
                $queryRun = mysqli_query($conn,$sqlLF);
            ...
            <div class="newsFeed">
                <div class="rounded shadow-lg">
                    ...
                    <pre style="margin-left: 53px; font-size:12px;"><b>Animal Type:</b> <?php echo $row['type'] ?></pre>
                    <pre style="margin-left: 53px; font-size:12px;"><b>Location:</b> <?php echo $row['location'] ?></pre>
                    <br>
