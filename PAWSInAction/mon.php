...
<div style="background-color: #F2F2F2;">
    ...
    <div class="row adminNavigations">
        ...
        <div class="adminNavs col-md-2" style="background-color:#BDD7EE; border-color:gold; border-width:3px;">
                <?php
                    include_once('utilities/dbconnect.php');
                    $sqlMon = "SELECT * FROM adopt WHERE adopted = 1";
                    $monPop = mysqli_query($conn, $sqlMon);
                    $sql2Mon = "SELECT * FROM foster WHERE approved = 1";
                    $mon2Pop = mysqli_query($conn, $sql2Mon);
                    if ($monPop && $mon2Pop){ 
                        // it return number of rows in the table. 
                        $row = mysqli_num_rows($monPop);
                        $row2 = mysqli_num_rows($mon2Pop); 
                            if ($row) { 
                                $totalMon = $row + $row2; 
                            }else{
                                $totalMon = "0";
...
<div class="container-fluid adminContBorder" style="background-color:#BDD7EE;">
    <div class="container">
        <div class="row">
            <div class="col-lg-6"><br>
                <h2 class="rounded adminHead">Adopter/s</h2>
                    ...
                    <table class="table table-hover" style="background-color:#F2F2F2; font-size:15px;">
                        ...
                        <tbody>
                                <?php
                                    ...
                                    $sqlAdopt = mysqli_query($conn,"SELECT * FROM adopt WHERE adopted = 1");
            ...
            <div class="col-lg-6"><br>
                <h2 class="rounded adminHead">Fosterer/s</h2>
                <div class="table-responsive">
                    <table class="table table-hover" style="background-color:#F2F2F2; font-size:15px;">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                                <?php
                                    ...
                                    $sqlFoster = mysqli_query($conn,"SELECT * FROM foster WHERE approved = 1");
                                    // fetch data from database
